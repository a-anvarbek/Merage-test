  ...
  return (
    <section className="relative bg-nippon-black section-padding overflow-hidden">
      <div className="absolute inset-0">
        <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-nippon-gold opacity-2 blur-3xl"></div>
        <div className="absolute bottom-1/3 left-1/4 w-64 h-64 rounded-full bg-nippon-gold opacity-3 blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto content-padding">
        ...
        <div className="mt-32 pt-16 border-t border-nippon-gold/20 text-center">
