...
export function SignatureMultiDayTours() {
  ...
  const handleTourRequest = (tourId) => {
    ...
    const selectedTourData = setTours.find(tour => tour.id === tourId);
    setFormData({
      ...formData,
  ...
  const handleFormSubmit = (e) => {
    ...
    // Here would integrate with CRM/concierge system
    setShowRequestModal(false);
    // Show confirmation message
  };

  const scrollToTours = () => {
    document.getElementById('tour-options')?.scrollIntoView({ behavior: 'smooth' });
  };
  ...
  return (
    <div className="relative">
      ...
      {/* Philosophy Introduction - COMPACT PADDING */}
      ...
      {/* Custom Itinerary Block - COMPACT PADDING */}
      <section className="relative bg-nippon-warm-white section-padding-compact overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto content-padding text-center" data-scroll-reveal>
