...
export function KamakuraHeritageTrip() {
  ...
  const [expandedItinerary, setExpandedItinerary] =
  ...
  useEffect(() => {
    if (selectedVehicle && formData.guestCount) {
      const basePrice =
        vehicles.find((v) => v.id === selectedVehicle)?.basePrice || 130000;
  ...
  const itineraryHighlights = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1661495897990-45bbe0bc78df?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxUc3VydWdhb2thJTIwSGFjaGltYW5ndSUyMFNocmluZSUyMEthbWFrdXJhfGVufDF8fHx8MTc1NTc1MjYwN3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
    {
      icon: Flower2,
      title: "Meigetsu-in Temple",
      description:
        "Known as the Hydrangea Temple — and for its iconic round window view.",
      detailedDescription:
        "Discover the enchanting Meigetsu-in Temple, famous throughout Japan for its spectacular hydrangea blooms and the mesmerizing round window that frames a perfect garden view. This Zen temple, founded in 1160, offers a contemplative atmosphere where seasonal flowers create a living mandala of color. The temple's gardens are meticulously maintained to provide year-round beauty.",
      duration: "45 minutes",
      highlights: [
        "Hydrangea Temple",
        "Round Window View",
      ...
      image:
        "https://images.unsplash.com/photo-1741496172387-fc0773e848f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxNZWlnZXRzdS1pbiUyMFRlbXBsZSUyMGh5ZHJhbmdlYSUyMEphcGFufGVufDF8fHx8MTc1NTc1MjYwOHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
    {
      icon: TreePine,
      title: "Kencho-ji Temple",
      description:
        "One of Japan's oldest Zen monasteries, with sweeping temple grounds.",
      detailedDescription:
        "Experience the profound tranquility of Kencho-ji, Japan's oldest Zen training monastery founded in 1253. This National Treasure complex features magnificent temple halls, ancient juniper trees, and meditation gardens that have remained unchanged for centuries. Walk the same paths where monks have practiced Zen meditation for over 750 years, surrounded by forested hills.",
      duration: "90 minutes",
      highlights: [
        "Japan's Oldest Zen Monastery",
        "National Treasure",
        "Ancient Juniper Trees",
        "750-Year Meditation Tradition",
      ],
    ...
    },
    {
      ...
      description:
        "Extend the day with sea breezes, shrines, and coastal caves (tide-dependent).",
      detailedDescription:
        "Complete your coastal heritage experience with an optional visit to mystical Enoshima Island. Connected by bridge, this sacred island features ancient shrines dedicated to the goddess Benzaiten, dramatic coastal caves carved by centuries of waves, and panoramic ocean views. The island's romantic atmosphere and fresh sea air provide the perfect conclusion to your cultural journey.",
      duration: "90 minutes",
      highlights: [
        "Sacred Island",
        "Benzaiten Shrines",
      ...
      image:
        "https://images.unsplash.com/photo-1715135566704-8d1300d9d484?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxFbm9zaGltYSUyMElzbGFuZCUyMEphcGFuJTIwY29hc3RhbHxlbnwxfHx8fDE3NTU3NTI2MDl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
  ];
  ...
  const scrollToVehicles = () => {
    document
      .getElementById("vehicle-selection")
                ...
                <div className="bg-nippon-beige/30 p-6 rounded-lg border border-nippon-border space-y-4">
                  <div className="border-b border-nippon-gold/20 pb-3">
                    ...
                    <p className="text-luxury-sm text-nippon-gray font-sans">
                      Basic information for your Kamakura Heritage Trip
                    </p>
                  </div>
        ...
        >
          <div className="max-w-4xl text-center">
            ...
            <div className="space-y-12 max-w-3xl mx-auto">
              ...
              >
                A coastal retreat into Japan's samurai past — rich with
                spiritual beauty, forested temples, and timeless charm.
              </p>
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-8 max-w-3xl mx-auto">
              <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans">
                Just an hour outside Tokyo, Kamakura offers a profound contrast
                — where centuries-old Zen temples meet ocean air and leafy
                mountain paths.
              </p>

              <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans">
                Once the political capital of Japan, today Kamakura is a
                tranquil city of heritage, ideal for a peaceful cultural day.
              </p>
            </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto content-padding">
          ...
          <div className="text-center" data-scroll-reveal>
            <p className="text-luxury-base text-nippon-gray-light font-sans italic leading-relaxed max-w-2xl mx-auto">
              ...
              Route is flexible and tailored to weather, interests, and seasonal
              access.
            </p>
          </div>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-luxury-base text-nippon-gray font-sans">
                      History lovers, spiritual travelers, nature walkers, art
                      photographers
                    </p>
                  </div>
                </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto content-padding">
          <div className="text-center space-y-8 mb-16" data-scroll-reveal>
            ...
            <p className="text-luxury-lg text-nippon-gray font-sans leading-relaxed max-w-2xl mx-auto">
              Real experiences from travelers who've discovered Kamakura's
              samurai heritage with Nippon Imperial.
            </p>
          </div>
        ...
        >
          <div className="space-y-12">
            <div className="space-y-8">
              ...
              <p className="text-luxury-xl text-nippon-gray-light font-sans leading-relaxed max-w-2xl mx-auto">
                Our concierge team is available 24/7 to customize your Kamakura
                heritage experience and answer any questions.
              </p>
            </div>
