import { MapPin, Phone, Mail, Globe, Facebook, Twitter, Instagram, Youtube, Car, Star, Award, Shield } from 'lucide-react';
    ...
    <footer className="relative bg-nippon-black text-nippon-warm-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-luxury-base text-nippon-gray-light leading-relaxed">
                Curating extraordinary luxury travel experiences across Japan with imperial elegance and cultural authenticity.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-luxury-sm text-nippon-gray-light">Licensed</span>
              </div>
              <div className="flex items-center space-x-2">
                <Award className="w-5 h-5 text-nippon-gold" />
                <span className="text-luxury-sm text-nippon-gray-light">5-Star</span>
              </div>
            </div>
          </div>
          ...
          {/* Services Links */}
          <div className="space-y-6">
            <h4 className="text-luxury-lg text-nippon-warm-white font-serif">Our Services</h4>
            <ul className="space-y-3">
              {[
                { label: 'Signature Day Escapes', id: 'day-escapes', key: 'services-day-escapes' },
                { label: 'Multi-Day Tours', id: 'multi-day-tours', key: 'services-multi-day' },
                { label: 'Tokyo Experiences', id: 'tokyo-highlights', key: 'services-tokyo' },
                { label: 'Mt. Fuji Tours', id: 'mt-fuji-escape', key: 'services-fuji' },
                { label: 'Cultural Immersion', id: 'nikko-cultural', key: 'services-cultural' },
                { label: 'Concierge Services', id: 'contact', key: 'services-concierge' }
              ].map((service) => (
                <li key={service.key}>
                  <button
          ...
          {/* Company Links */}
          <div className="space-y-6">
            <h4 className="text-luxury-lg text-nippon-warm-white font-serif">Company</h4>
            <ul className="space-y-3">
              {[
                ...
                { label: 'Travel Guidelines', id: 'contact', key: 'company-guidelines' },
                { label: 'Sustainability', id: 'essence', key: 'company-sustainability' },
                { label: 'Partnerships', id: 'contact', key: 'company-partnerships' }
              ].map((link) => (
                <li key={link.key}>
                  <button
          ...
          {/* Contact Information */}
          <div className="space-y-6">
            <h4 className="text-luxury-lg text-nippon-warm-white font-serif">Contact</h4>
