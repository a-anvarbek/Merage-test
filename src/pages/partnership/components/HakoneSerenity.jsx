...
// Notes:
// - All TypeScript types were removed
// - Generics like useState<string> replaced with useState()
...
export function HakoneSerenity() {
 ...
 const guestMultiplier = parseInt(formData.guestCount) > 4 ? 1.2 ;
 ...
 setExpandedItinerary(expandedItinerary === index ? null );
 };
 ...
 className="p-1 bg-transparent hover-nippon-gray/10 text-nippon-gray hover-nippon-black transition-colors"
 ...
 onChange={(e) => setFormData({...formData, tourDate.target.value})}
 ...
 <Select onValueChange={(value) => setFormData({...formData, guestCount)}>
 ...
 <Select onValueChange={(value) => setFormData({...formData, luggageCount)}>
 <SelectTrigger className="enhanced-luxury-input">
 ...
 onChange={(e) => setFormData({...formData, pickupAddress.target.value})}
 className="enhanced-luxury-input"
 ...
 onChange={(e) => setFormData({...formData, specialNotes.target.value})}
 ...
 className="group relative overflow-hidden w-full bg-transparent border-2 border-nippon-gold text-nippon-gold hover-nippon-black font-sans text-luxury-base px-6 py-4 transition-all duration-500 shadow-gold hover-gold-hover transform hover:-translate-y-2 hover-nippon-gold disabled-50 disabled-not-allowed disabled-none"
 style={{
 ...
 <div className="mt-20 flex flex-col sm-row gap-4 justify-center">
 <Button
 onClick={scrollToVehicles}
 className="group relative overflow-hidden bg-transparent border-2 border-nippon-gold text-nippon-gold hover-nippon-black font-sans text-luxury-base px-8 py-4 transition-all duration-500 shadow-gold hover-gold-hover transform hover:-translate-y-2 hover-nippon-gold"
 style={{
 backdropFilter'blur(20px)',
 backgroundColor'rgba(0, 0, 0, 0.6)',
 }}
 ...
 <div className="grid grid-cols-2 md-cols-4 gap-8 pt-8">
 <div className="text-center">
 ...
 <div className="grid md-cols-2 lg-cols-4 gap-6 mb-16">
 {itineraryHighlights.map((highlight, index) => (
 <div
 key={index}
 className={`group relative bg-nippon-warm-white shadow-luxury hover-luxury-hover transition-all duration-500 overflow-hidden border-l-4 border-nippon-gold cursor-pointer ${
 expandedItinerary === index ? 'col-span-full md-span-2' ''
 }`}
 data-scroll-reveal
 ...
 {expandedItinerary === index ? <ChevronUp className="w-5 h-5 text-nippon-gold" /> ="w-5 h-5 text-nippon-gold" />}
 </div>
 
 <p className="text-luxury-sm text-nippon-gray leading-relaxed font-sans">
 {expandedItinerary === index ? highlight.detailedDescription .description}
 </p>
 ...
 <div className="grid md-cols-3 gap-16">
 ...
 <div>
 <p className="text-luxury-lg text-nippon-black font-serif">Duration/p>
 <p className="text-luxury-base text-nippon-gray font-sans">8- 6/p>
 </div>
 </div>
 ...
 <div className="grid md-cols-2 lg-cols-4 gap-8">
 {vehicles.map((vehicle, index) => (
 <Card
 key={vehicle.id}
 className="group relative bg-nippon-warm-white hover-luxury-hover transition-all duration-500 overflow-hidden border-l-4 border-nippon-gold cursor-pointer"
 data-scroll-reveal
 ...
 <Button 
 className="group relative overflow-hidden w-full bg-transparent border-2 border-nippon-gold text-nippon-gold hover-nippon-black font-sans text-luxury-sm px-4 py-3 transition-all duration-500 shadow-gold hover-gold-hover transform hover:-translate-y-2 hover-nippon-gold"
 style={{
 ...
 >
 <span className="absolute inset-0 bg-nippon-gold transform scale-x-0 group-hover-x-100 transition-transform duration-500 origin-left"></span>
 <span className="relative flex items-center justify-center space-x-2 text-nippon-gold group-hover-nippon-black">
 ...
 <Card
 key={index}
 className="bg-nippon-warm-white border-l-4 border-nippon-gold shadow-luxury hover-luxury-hover transition-all duration-500"
 data-scroll-reveal
