...
import toshoguShrineImage from "figma:asset/7589bc703e176a119972e736b62158b947d1376d.png";
import shinkyoBridgeImage from "figma:asset/e46be92cdd62c111da5033245dfa636450c03335.png";
import lakeChuzenjiImage from "figma:asset/8292132e5ac314805f977856535342926080b2d5.png";
import irohazakaRoadImage from "figma:asset/8a0d4dc078d8c52089455d14e16bbc9098f3deee.png";

export function NikkoCulturalDiscovery() {
  ...
  const itineraryHighlights = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1698618416413-f5e57f530bcc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxLZWdvbiUyMEZhbGxzJTIwTmlra28lMjB3YXRlcmZhbGx8ZW58MXx8fHwxNzU1NjcyODY0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
    {
      icon: Mountain,
      title: "Lake Chuzenji",
      description:
        "Tranquil crater lake at the foot of Mt. Nantai with panoramic mountain reflections.",
      detailedDescription:
        "Discover the serene beauty of Lake Chuzenji, a pristine crater lake formed over 20,000 years ago at the foot of the sacred Mt. Nantai. This alpine sanctuary offers breathtaking reflections of surrounding mountains, peaceful walking paths, and a spiritual atmosphere that has inspired poets and artists for centuries.",
      duration: "75 minutes",
      highlights: [
        "Crater Lake Beauty",
        "Mt. Nantai Views",
    ...
    },
    {
      ...
      description:
        "A scenic and iconic ascent with 48 curves through Nikko's forests.",
      detailedDescription:
        "Experience one of Japan's most famous mountain roads, where 48 curves wind through pristine forests, each named after a character from the traditional Japanese alphabet. This engineering marvel offers spectacular seasonal views, from vibrant autumn foliage to winter snow scenes, creating an unforgettable journey through Nikko's natural beauty.",
      duration: "45 minutes",
      highlights: [
        "48 Named Curves",
        "Forest Scenery",
    ...
    },
    {
      ...
      detailedDescription:
        "Savor the authentic flavors of Nikko's regional cuisine at a carefully selected traditional restaurant. Enjoy seasonal specialties that reflect the mountain region's bounty, from fresh river fish to locally grown vegetables, all prepared with centuries-old techniques and presented in the elegant Japanese style.",
      duration: "90 minutes",
      highlights: [
      ...
      image:
        "https://images.unsplash.com/photo-1719464453353-abffa00097ab?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxKYXBhbmVzZSUyMHRyYWRpdGlvbmFsJTIwbHVuY2glMjBjdWlzaW5lfGVufDF8fHx8MTc1NTY3Mjg2NXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
  ];
                ...
                <div className="bg-nippon-beige/30 p-6 rounded-lg border border-nippon-border space-y-4">
                  <div className="border-b border-nippon-gold/20 pb-3">
                    ...
                    <p className="text-luxury-sm text-nippon-gray font-sans">
                      Basic information for your Nikko Cultural Discovery
                    </p>
                  </div>
        ...
        >
          <div className="max-w-4xl text-center">
            ...
            <div className="space-y-12 max-w-3xl mx-auto">
              ...
              >
                A sacred mountain escape filled with heritage, forested
                landscapes, and World Heritage beauty — all within reach of
                Tokyo.
              </p>
        ...
        >
          <div className="space-y-12">
            ...
            <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans max-w-3xl mx-auto">
              Venture into the mysticism and grandeur of Nikko — a UNESCO World
              Heritage region where Shinto legends, Edo architecture, and
              mountain serenity converge. This full-day private tour invites you
              to breathe fresh alpine air, explore ancient shrines, and connect
              with Japan's spiritual heartland.
            </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-luxury-base text-nippon-gray font-sans">
                      Nature lovers, spiritual travelers, heritage photographers
                    </p>
                  </div>
                </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto content-padding">
          <div className="text-center space-y-8 mb-16" data-scroll-reveal>
            ...
            <p className="text-luxury-lg text-nippon-gray font-sans leading-relaxed max-w-2xl mx-auto">
              Real experiences from travelers who've discovered Nikko's cultural
              heritage with Nippon Imperial.
            </p>
          </div>
        ...
        >
          <div className="space-y-12">
            <div className="space-y-8">
              ...
              <p className="text-luxury-xl text-nippon-gray-light font-sans leading-relaxed max-w-2xl mx-auto">
                Our concierge team is available 24/7 to customize your Nikko
                cultural discovery and answer any questions.
              </p>
            </div>
