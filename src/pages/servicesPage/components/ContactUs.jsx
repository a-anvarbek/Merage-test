...
export function ContactUs() {
  ...
  return (
    <div className="min-h-screen bg-nippon-black relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-nippon-gold opacity-4 blur-3xl"></div>
      <div className="absolute bottom-1/4 left-1/4 w-64 h-64 rounded-full bg-nippon-gold opacity-6 blur-3xl"></div>
      <div className="absolute top-1/2 right-1/3 w-48 h-48 rounded-full bg-nippon-gold-muted opacity-3 blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto content-padding section-padding-sm">
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="space-y-16">
              {/* Contact Info */}
              {/* ... same as your code (unchanged, JSX safe) ... */}
            </div>
