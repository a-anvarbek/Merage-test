  ...
  return (
    <div className="min-h-screen bg-nippon-black relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url("data:image/svg+xml,%3Csvg width='120' height='120' ... %3C/svg%3E")`,
              ...
              <div className="warm-white-card-secondary p-10 shadow-elegant">
                ...
                <div className="mb-12 luxury-fade-up">
                  ...
                  <div className="flex items-start space-x-6">
                    <div className="flex-shrink-0 w-12 h-12 border-2 border-nippon-gold ...">
                ...
                <div className="mb-12 luxury-fade-up">
                  ...
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <p className="text-luxury-2xl text-nippon-black font-serif">Japan, Tokyo</p>
                      <p className="text-luxury-2xl text-nippon-black font-serif">Ginza 1-1-1</p>
                    </div>
                  </div>
                </div>
                {/* Socials */}
                <div className="luxury-fade-up">
                  ...
                  <div className="flex space-x-6">
                    <div className="w-12 h-12 border-2 border-nippon-gold ..."><Facebook className="w-6 h-6" /></div>
                    <div className="w-12 h-12 border-2 border-nippon-gold ..."><Instagram className="w-6 h-6" /></div>
                    <div className="w-12 h-12 border-2 border-nippon-gold ..."><Linkedin className="w-6 h-6" /></div>
                    <div className="w-12 h-12 border-2 border-nippon-gold ..."><Twitter className="w-6 h-6" /></div>
                  </div>
                </div>
              </div>
            </div>
