    ...
    return (
      <div className="min-h-screen bg-nippon-black relative flex items-center justify-center">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto px-6 warm-white-card-secondary p-12 shadow-luxury">
          <h1 className="text-luxury-6xl text-nippon-gold font-serif mb-8 text-with-gold-glow">Thank You</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            <div className="space-y-16" data-scroll-reveal>
              ...
              <div className="warm-white-card-secondary p-10 shadow-elegant">
                <h2 className="text-luxury-4xl text-nippon-black font-serif mb-12 text-with-black-shadow">How to Contact Us</h2>
                <div className="mb-12 luxury-fade-up">
                  <h3 className="text-luxury-xl text-nippon-gold font-serif mb-6 text-with-gold-glow">Personal Concierge Hotline:</h3>
                ...
                {/* Email Address */}
                <div className="mb-12 luxury-fade-up">
                  <h3 className="text-luxury-xl text-nippon-gold font-serif mb-6 text-with-gold-glow">Email Address:</h3>
                  <div className="flex items-start space-x-6">
                    <div className="flex-shrink-0 w-12 h-12 border-2 border-nippon-gold bg-nippon-warm-white-light flex items-center justify-center mt-2 gold-glow shadow-gold hover:shadow-gold-hover transition-all duration-300">
                ...
                {/* Office Address */}
                <div className="mb-12 luxury-fade-up">
                  <h3 className="text-luxury-xl text-nippon-gold font-serif mb-6 text-with-gold-glow">Office Address:</h3>
                  <div className="flex items-start space-x-6">
                    <div className="flex-shrink-0 w-12 h-12 border-2 border-nippon-gold bg-nippon-warm-white-light flex items-center justify-center mt-2 gold-glow shadow-gold hover:shadow-gold-hover transition-all duration-300">
                ...
                <div className="luxury-fade-up">
                  <h3 className="text-luxury-xl text-nippon-gold font-serif mb-6 text-with-gold-glow">Follow Us:</h3>
                  <div className="flex space-x-6">
                    <div className="w-12 h-12 border-2 border-nippon-gold bg-nippon-warm-white-light flex items-center justify-center hover:bg-nippon-gold hover:text-nippon-black transition-all duration-500 cursor-pointer shadow-gold hover:shadow-gold-hover transform hover:-translate-y-1"><Facebook className="w-6 h-6" /></div>
                    <div className="w-12 h-12 border-2 border-nippon-gold bg-nippon-warm-white-light flex items-center justify-center hover:bg-nippon-gold hover:text-nippon-black transition-all duration-500 cursor-pointer shadow-gold hover:shadow-gold-hover transform hover:-translate-y-1"><Instagram className="w-6 h-6" /></div>
                    <div className="w-12 h-12 border-2 border-nippon-gold bg-nippon-warm-white-light flex items-center justify-center hover:bg-nippon-gold hover:text-nippon-black transition-all duration-500 cursor-pointer shadow-gold hover:shadow-gold-hover transform hover:-translate-y-1"><Linkedin className="w-6 h-6" /></div>
                    <div className="w-12 h-12 border-2 border-nippon-gold bg-nippon-warm-white-light flex items-center justify-center hover:bg-nippon-gold hover:text-nippon-black transition-all duration-500 cursor-pointer shadow-gold hover:shadow-gold-hover transform hover:-translate-y-1"><Twitter className="w-6 h-6" /></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div data-scroll-reveal>
              <div className="warm-white-card-secondary p-10 shadow-elegant">
                <h2 className="text-luxury-4xl text-nippon-black font-serif mb-8 text-with-black-shadow">Contact Form</h2>
                <div className="gold-divider h-px w-24 mb-8"></div>
                
                <form onSubmit={handleSubmit} className="space-y-8">
                  <Input value={formData.fullName} onChange={(e) => handleInputChange('fullName', e.target.value)} placeholder="Full Name" className="luxury-input h-14 text-luxury-lg" required />
                  <Input type="email" value={formData.email} onChange={(e) => handleInputChange('email', e.target.value)} placeholder="Email" className="luxury-input h-14 text-luxury-lg" required />
                  <Input value={formData.phoneNumber} onChange={(e) => handleInputChange('phoneNumber', e.target.value)} placeholder="Phone Number" className="luxury-input h-14 text-luxury-lg" />
                  <Select value={formData.subject} onValueChange={(value) => handleInputChange('subject', value)}>
                    <SelectTrigger className="luxury-input h-14 text-luxury-lg"><SelectValue placeholder="Subject" /></SelectTrigger>
                  ...
                  <Textarea value={formData.message} onChange={(e) => handleInputChange('message', e.target.value)} placeholder="Message" rows={6} className="luxury-input text-luxury-lg resize-none" required />
                  <Checkbox id="contactPhone" checked={formData.contactViaPhone} onCheckedChange={(checked) => handleInputChange('contactViaPhone', checked)} className="luxury-checkbox" />
                  <label htmlFor="contactPhone" className="text-nippon-black font-sans text-luxury-lg">I would like to be contacted via phone</label>
                  <Button type="submit" className="group relative overflow-hidden bg-transparent border-2 border-nippon-gold text-nippon-gold hover:text-nippon-black font-serif text-luxury-lg px-12 py-4 transition-all duration-500 shadow-gold hover:shadow-gold-hover transform hover:-translate-y-1 hover:bg-nippon-gold luxury-button-gold">
