...
// - Version-suffixed imports were normalized (e.g., "@radix-ui/react-slot@1.1.2" -> "@radix-ui/react-slot")
// - This file assumes the corresponding components (button, input, etc.) exist locally
