...
export function Concierge() {
  const services = [
    {
      icon: "Accommodation Reservations",
    ...
    {
      icon: "Restaurant & Nightlife Bookings",
    ...
    {
      icon: "Luxury Transport",
      description: "Chauffeur-driven cars, minivans and luxury transfers arranged at any time, ensuring your journey is destination.",
      image: "Arrange Your Ride"
    },
    {
      icon: "Signature Day Escapes",
      description: "Immersive one-day itineraries designed around seasons and interests, with every logistic handled discreetly.",
      image: "Design Your Escape"
    },
    {
      icon: "Special Experiences",
    ...
    {
      icon: "Private Guide Arrangements",
      ...
      image: "Meet Your Guide"
    }
  ];

  // Flagship service - positioned premium centerpiece
  const flagshipService = {
    icon: "Travel Consultation & Custom Journeys",
              ...
              <div className="relative max-w-3xl mx-auto">
                ...
                <div className="relative px-10 py-8">
                  <p className="text-luxury-2xl text-nippon-black font-serif italic leading-relaxed">
                    What if every element of your journey could flow seamless experience?
                  </p>
                </div>
              </div>
            </div>
