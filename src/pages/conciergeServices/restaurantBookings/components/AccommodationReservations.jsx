  ...
  const highlights = [
    {
      ...
      description: "Open-air baths and seasonal kaiseki dining",
      image: ryokanImage
    },
    {
      icon: Building,
      title: "Luxury City Hotels",
      description: "Skyline views and concierge-level amenities",
      image: cityHotelImage
    },
    {
      icon: Hotel,
      title: "Historic Machiya",
      description: "Authentic cultural immersion experiences",
      image: historicMachiyaImage
    },
    {
      icon: Users,
      title: "VIP Services",
      description: "Discreet check-in and personalized arrangements",
  ...
  const processSteps = [
    {
      ...
      description: "Share your preferences for location, style, amenities, and special requests.",
      icon: MapPin
    },
    {
      step: "02", 
      title: "We Curate Your Stay",
      description: "Our concierge will propose handpicked options, each with detailed recommendations.",
      icon: Star
    },
    {
      step: "03",
      title: "Confirm & Arrive",
      description: "Once confirmed, all arrangements are secured — from welcome amenities to check-in assistance.",
      icon: CheckCircle
    }
  ];
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-8" data-scroll-reveal>
          <div className="max-w-4xl text-center">
            ...
            <h1 className="text-luxury-7xl lg:text-luxury-8xl text-nippon-warm-white font-serif mb-16 leading-none tracking-tight"
              ...
              Your Perfect Stay, Thoughtfully Arranged.
            </h1>
            ...
            {/* Subtitle */}
            <p className="text-luxury-xl text-nippon-warm-white font-sans leading-relaxed max-w-2xl mx-auto mb-16"
               style={{
                 textShadow: '0 3px 8px rgba(0, 0, 0, 0.8), 0 1px 4px rgba(0, 0, 0, 0.7)'
               }}>
              From mountain onsen to city penthouses, every accommodation is the perfect backdrop to your Japanese story.
            </p>
            ...
            <div>
              ...
              >
                ...
                <span className="relative flex items-center space-x-3">
                  <span className="tracking-wider font-medium">Reserve Your Stay</span>
