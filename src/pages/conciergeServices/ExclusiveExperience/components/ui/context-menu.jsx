  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground min-w-[8rem] max-h-(--radix-context-menu-content-available-height) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md",
          className
        )}
        {...props}
      />
