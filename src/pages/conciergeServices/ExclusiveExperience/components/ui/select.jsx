...
export function SelectLabel(props) {
  return <SelectPrimitive.Label data-slot="select-label" className="text-muted-foreground px-2 py-1.5 text-xs" {...props} />;
}
...
export function SelectSeparator(props) {
  return <SelectPrimitive.Separator data-slot="select-separator" className="bg-border pointer-events-none -mx-1 my-1 h-px" {...props} />;
}
