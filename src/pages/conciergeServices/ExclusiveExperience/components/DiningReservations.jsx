...
import { Utensils, CheckCircle, ArrowRight, Clock, Star, Award, Wine, ChefHat, Calendar, MapPin } from 'lucide-react';
import { Button } from './ui/button';
import { Input } from './ui/input';
import { Textarea } from './ui/textarea';
import { Label } from './ui/label';
import { ImageWithFallback } from './figma/ImageWithFallback';
import tokyoNightDiningImage from 'figma:asset/8978d524513a0a3efb08e2670bc73450ac45137b.png';
import michelinRestaurantImage from 'figma:asset/a5dcde9b2a6d55e1ba9f7fb35207e7ea540cbe89.png';
import omakaseSushiImage from 'figma:asset/afafad232564cd52e8f470084cbe6e3a2f692d90.png';
 ...
 const handleInputChange = (e) => {
  ...
  const highlights = [
    {
      ...
      description: "Private access to Japan's most revered sushi artisans and their intimate dining sanctuaries",
    ...
    },
    {
      ...
      description: "Exclusive entry to Japan's secretive cocktail havens and rooftop sanctuaries",
      image: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=90",
      badge: "Private Access"
    },
    {
      icon: ChefHat,
      title: "Kaiseki & Omakase",
      description: "Seasonal artistry from Japan's most celebrated culinary masters",
    ...
    },
    {
      ...
      description: "Transportation, etiquette guidance, and seamless cultural immersion",
      image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=90",
      badge: "Full Service"
    }
  ];
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description: "We present carefully chosen options, each vetted for quality, privacy, and authenticity.",
      icon: Star
    },
    {
      step: "03",
      title: "Enjoy With Ease", 
      description: "Your table, time, and any special arrangements are confirmed — all you need to do is arrive.",
      icon: CheckCircle
    }
  ];
  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div 
            ...
            style={{
              ...
              animation: 'cinematicFloat 25s ease-in-out infinite alternate-reverse'
            }}
          ></div>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-8 h-full flex items-center justify-center" data-scroll-reveal>
          <div className="w-full min-h-[80vh] flex flex-col justify-center items-center text-center space-y-12">
            ...
            <div className="space-y-6">
              <h1 className="text-luxury-6xl md:text-luxury-7xl lg:text-luxury-8xl text-nippon-warm-white font-serif leading-[0.85] tracking-tight"
                  style={{
                    textShadow: '0 6px 16px rgba(0, 0, 0, 0.9), 0 3px 8px rgba(0, 0, 0, 0.8), 0 1px 4px rgba(0, 0, 0, 0.7)'
                  }}>
              ...
              <div className="relative mt-8">
                <h2 className="text-luxury-4xl md:text-luxury-5xl lg:text-luxury-6xl text-nippon-warm-white font-serif tracking-wide opacity-90"
                    style={{
            ...
            <div className="max-w-2xl">
              <p className="text-luxury-lg md:text-luxury-xl text-nippon-pearl font-sans leading-relaxed"
                 style={{
                   textShadow: '0 4px 12px rgba(0, 0, 0, 0.9), 0 2px 6px rgba(0, 0, 0, 0.8)'
                 }}>
                From legendary sushi masters to hidden izakaya sanctuaries, experience Japan's most coveted culinary temples through our exclusive network of cultural artisans and epicurean guardians across Tokyo, Kyoto, Osaka, and beyond.
              </p>
            </div>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-luxury-xl text-nippon-black font-serif italic leading-relaxed">
                  From discreet omakase counters to exclusive rooftop lounges, Nippon Imperial opens doors to Japan's most sought-after tables and nightlife experiences.
                </p>
                
                <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans">
                  Whether you seek a quiet, candlelit dinner or a lively evening in the city's hidden gems, each reservation is curated to match your taste, style, and occasion. Our relationships with select establishments ensure access to tables, experiences, and moments often unavailable elsewhere.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="dining-form" className="relative bg-nippon-warm-white section-padding overflow-hidden">
        {/* Background pattern */}
        <div className="absolute inset-0 opacity-2">
          <div 
            className="w-full h-full"
        ...
        <div className="relative z-10 max-w-4xl mx-auto content-padding">
          <div className="text-center mb-16" data-scroll-reveal>
            ...
            <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans max-w-2xl mx-auto">
              Share your dining preferences and let our culinary concierge curate an extraordinary evening tailored to your taste.
            </p>
          </div>
            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-nippon-gray font-sans leading-relaxed">
                  Thank you for your dining reservation request. Our culinary concierge will contact you within 2 hours to confirm your exceptional table.
                  <br /><br />
                  <strong>Request ID:</strong> DR-{Math.random().toString(36).substr(2, 9).toUpperCase()}
                </p>
              </div>
            ) : (
              <form onSubmit={handleFormSubmit} className="space-y-8">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="name" className="text-nippon-black font-sans">Name *</Label>
                    <Input
                      id="name"
                      name="name"
                      type="text"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="date" className="text-nippon-black font-sans">Preferred Date *</Label>
                    <Input
                      id="date"
                      name="date"
                      type="date"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="time" className="text-nippon-black font-sans">Preferred Time *</Label>
                    <Input
                      id="time"
                      name="time"
                      type="time"
                ...
                <div className="space-y-2">
                  <Label htmlFor="preferences" className="text-nippon-black font-sans">Cuisine or Venue Preferences</Label>
                  <Textarea
                    id="preferences"
                    name="preferences"
                ...
                <div className="space-y-2">
                  <Label htmlFor="specialRequests" className="text-nippon-black font-sans">Special Requests & Preferences</Label>
                  <Textarea
                    id="specialRequests"
                ...
                <div className="pt-6">
                  ...
                  >
                    ...
                    <span className="relative flex items-center justify-center space-x-3">
                      ...
                      <span className="tracking-wider font-medium">Submit Dining Request</span>
                      <ArrowRight className="w-5 h-5 transform group-hover:translate-x-1 transition-transform duration-300" />
                    </span>
                  </Button>
                </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-nippon-gray font-sans text-luxury-xs leading-relaxed">
                    Our culinary concierge will follow up with curated dining options within 24 hours.
                  </p>
                </div>
              </div>
            </div>
