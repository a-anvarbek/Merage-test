...
import { Sparkles, CheckCircle, ArrowRight, Clock, Star, Crown, Mountain, Camera, Calendar, MapPin, Waves, Heart } from 'lucide-react';
  ...
  const highlights = [
    {
      ...
      description: "Audience with revered masters and evening encounters with geiko in hidden sanctuaries",
      image: "https://images.unsplash.com/photo-1528360983277-13d401cdc186?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=90",
      badge: "Grand Masters"
    },
    {
      icon: Waves,
      title: "Aerial & Water Experiences",
      description: "Charter helicopters over Mt. Fuji, traditional yakatabune cruises in Tokyo Bay, and sunset yacht journeys near Enoshima",
    ...
    },
    {
      ...
      description: "Design your visit with poetic timing — cherry blossom festivals, summer fireworks, and prefecture celebrations",
    ...
    },
    {
      ...
      description: "Proposals at ancient shrines, anniversary dinners on rooftops, birthday moments with floating candles on rivers",
  ...
  const processSteps = [
    {
      ...
      description: "Tell us the rare experience you wish to create — from cultural immersion to grand celebration.",
      icon: Sparkles
    },
    {
      step: "02", 
      title: "We Unlock Hidden Access",
      description: "Your concierge designs exclusive opportunities through our private network.",
      icon: Star
    },
    {
      step: "03",
      title: "Live the Extraordinary",
      description: "Every detail is handled with precision and discretion, leaving you free to simply experience.",
      icon: CheckCircle
    }
  ];
...
const handleFormSubmit = (e) => {
  ...
  const scrollToForm = () => {
    document.getElementById('exclusive-form')?.scrollIntoView({ behavior: 'smooth' });
  };
  ...
  return (
    <div className="relative">
          ...
          <div className="w-full min-h-[80vh] flex flex-col justify-center items-center text-center space-y-12">
            ...
            <div className="max-w-2xl">
              <p className="text-luxury-lg md:text-luxury-xl text-nippon-pearl font-sans leading-relaxed"
                ...
                From private helicopter tours over Mt. Fuji and Tokyo's illuminated skylines to once-in-a-lifetime encounters with cultural masters, each moment is bespoke, discreetly orchestrated, and elevated to its finest form.
              </p>
            </div>
            ...
            <div className="pt-8">
              ...
              >
                ...
                <span className="relative flex items-center space-x-3">
                  <span className="tracking-wider font-medium">Create Your Moment</span>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-luxury-xl text-nippon-black font-serif italic leading-relaxed">
                  Exclusive Experiences are reserved for those who wish to step beyond the ordinary.
                </p>
                
                <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans">
                  From private helicopter tours soaring over Mt. Fuji's sacred peaks and Tokyo's neon-lit metropolitan sprawl to once-in-a-lifetime encounters with cultural masters, Nippon Imperial curates experiences that cannot be found elsewhere. Each moment is bespoke, discreetly orchestrated, and elevated to its finest form.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="exclusive-form" className="relative bg-nippon-warm-white section-padding overflow-hidden">
        {/* Background pattern */}
        <div className="absolute inset-0 opacity-2">
          <div 
            className="w-full h-full"
        ...
        <div className="relative z-10 max-w-4xl mx-auto content-padding">
          <div className="text-center mb-16" data-scroll-reveal>
            ...
            <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans max-w-2xl mx-auto">
              Share your vision for an unforgettable moment, and our exclusive experience concierge will bring it to life with precision and discretion.
            </p>
          </div>
            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-nippon-gray font-sans leading-relaxed">
                  Thank you for your exclusive experience request. Our concierge will contact you within 4 hours to discuss your extraordinary moment.
                  <br /><br />
                  <strong>Request ID:</strong> EX-{Math.random().toString(36).substr(2, 9).toUpperCase()}
                </p>
              </div>
            ) : (
              <form onSubmit={handleFormSubmit} className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Label htmlFor="preferredDate" className="text-nippon-black font-sans">Preferred Date(s)</Label>
                    <Input
                      id="preferredDate"
                      name="preferredDate"
                      type="text"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="location" className="text-nippon-black font-sans">Location Preference</Label>
                    <Input
                      id="location"
                      name="location"
                      type="text"
                ...
                <div className="space-y-2">
                  <Label htmlFor="desiredExperience" className="text-nippon-black font-sans">Desired Experience *</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  <Label htmlFor="specialNotes" className="text-nippon-black font-sans">Special Notes or Requests</Label>
                  <Textarea
                    id="specialNotes"
                    name="specialNotes"
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-2">
                  <p className="text-nippon-black font-sans text-luxury-sm leading-relaxed">
                    <strong>Immediate Confirmation:</strong> You'll receive a personalized response within 4 hours with your request ID and next steps.
                  </p>
                  <p className="text-nippon-gray font-sans text-luxury-xs leading-relaxed">
                    Our exclusive experience team will work discreetly to arrange every detail of your extraordinary moment.
                  </p>
                </div>
              </div>
            </div>
