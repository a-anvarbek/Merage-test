      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center text-nippon-warm-white">
            <h1 className="text-luxury-6xl font-serif mb-8">Video Background Test</h1>
            <p className="text-luxury-xl font-sans mb-4">Testing video playback capabilities</p>
            {videoLoaded && <p className="text-nippon-gold font-sans">✓ Video is playing successfully</p>}
            {videoError && <p className="text-red-400 font-sans">✗ Video failed to load - showing fallback image</p>}
          </div>
        </div>
      </div>
    </div>
