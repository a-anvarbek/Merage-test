  ...
  return (
    <section className="relative bg-nippon-black section-padding overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div
          className="absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-nippon-gold opacity-2 blur-3xl"
          data-scroll-parallax
          data-scroll-speed="0.1"
        ></div>
        <div
          className="absolute bottom-1/3 left-1/4 w-64 h-64 rounded-full bg-nippon-gold opacity-3 blur-3xl"
          data-scroll-parallax
                  ...
                  <div className="relative">
                    <div className="w-80 h-80 mx-auto relative">
                      ...
                      <div className="absolute inset-16 rounded-full bg-nippon-gold/10 backdrop-blur-sm border-2 border-nippon-gold flex items-center justify-center gold-glow">
                        <Icon className="w-24 h-24 text-nippon-gold" />
                      </div>
                    </div>
