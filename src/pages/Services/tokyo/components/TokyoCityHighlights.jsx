...
import harajukuImage from "../assets/Harajuku.png";
import shibuyaImage from "../assets/Shibuya.png";
import imperialPalaceImage from "../assets/ImperialPalace.png";
import ginzaImage from "../assets/Ginza.png";
import tsukijiImage from "../assets/Tsukiji.png";
import tokyoTowerImage from "../assets/TokyoTower.png";
import tokyoNightSkylineImage from "../assets/Ginza.png";

export default function TokyoCityHighlights() {
  ...
  useEffect(() => {
    if (selectedVehicle && formData.guestCount) {
      const basePrice =
        vehicles.find((v) => v.id === selectedVehicle)?.basePrice || 75000;
  ...
  const itineraryHighlights = [
    {
      ...
      description:
        "Tokyo's oldest Buddhist temple, paired with the vibrant Nakamise shopping street.",
      detailedDescription:
        "Begin your journey at Tokyo's spiritual heart, where centuries-old traditions thrive. Walk through the iconic Thunder Gate, browse traditional crafts on Nakamise Street, and experience the serene atmosphere of this 1,400-year-old temple.",
      duration: "90 minutes",
      highlights: [
      ...
      image:
        "https://images.unsplash.com/photo-1667314432098-6fd47117aa7f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBc2FrdXNhJTIwU2Vuc28tamklMjB0ZW1wbGV8ZW58MXx8fHwxNzU1NTk1OTQ2fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
    {
      icon: TreePine,
      title: "Meiji Jingu Shrine",
      description:
        "A serene Shinto sanctuary nestled in a tranquil forest — a spiritual haven in the heart of the city.",
      detailedDescription:
        "Step into a 175-acre forest oasis dedicated to Emperor Meiji. This sacred space offers a peaceful contrast to Tokyo's urban energy, featuring towering trees, traditional ceremonies, and Japan's most important Shinto shrine.",
      duration: "75 minutes",
      highlights: [
        "Sacred Forest Walk",
      ...
      image:
        "https://images.unsplash.com/photo-1720454206018-8d977e9e984a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxNZWlqaSUyMFNocmluZSUyMFRva3lvfGVufDF8fHx8MTc1NTU5NTk0NXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    },
    {
      icon: Building2,
      title: "Omotesando & Harajuku",
      description:
        "Striking architecture, luxury boutiques, and Tokyo's most eclectic youth culture.",
      detailedDescription:
        "Discover Tokyo's creative pulse where high fashion meets street style. Marvel at architectural masterpieces by world-renowned designers, explore luxury flagships, and witness the colorful expression of Japanese youth culture.",
      duration: "2 hours",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Panoramic city views and the pulse of the world's busiest crossing.",
      detailedDescription:
        "Experience Tokyo's kinetic energy at the world's busiest intersection. Take in panoramic city views from Shibuya Sky, and feel the pulse of urban Japan as thousands of people cross in perfect choreographed chaos.",
      duration: "90 minutes",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Historic stone ruins and peaceful traditional gardens amid Tokyo's political heart.",
      detailedDescription:
        "Walk through Japan's imperial history in these meticulously maintained gardens. Explore ancient castle foundations, seasonal flora, and traditional landscape design that has inspired gardens worldwide.",
      duration: "75 minutes",
      highlights: [
    ...
    },
    {
      ...
      description:
        "Flagship fashion, modern art, and refined Japanese design in a luxury retail setting.",
      detailedDescription:
        "Stroll through Tokyo's most prestigious shopping district, where luxury meets Japanese refinement. Explore flagship stores, art galleries, and experience the sophisticated atmosphere of Japan's premier luxury destination.",
      duration: "2 hours",
      highlights: [
        "Luxury Shopping",
        "Art Galleries",
    ...
    },
    {
      ...
      description:
        "A culinary hub for fresh seafood, street food, and Japanese kitchen culture.",
      detailedDescription:
        "Immerse yourself in Tokyo's culinary soul at this vibrant market. Sample the freshest sushi, discover unique Japanese ingredients, and experience the energy of Tokyo's food culture at its most authentic.",
      duration: "90 minutes",
      highlights: [
        "Fresh Sushi Tasting",
        "Street Food Culture",
    ...
    },
    {
      ...
      description:
        "Soar above the skyline with iconic views from one of Tokyo's tallest landmarks.",
      detailedDescription:
        "Crown your Tokyo experience with breathtaking panoramic views. Choose between the classic Tokyo Tower or the modern Skytree for unforgettable vistas spanning from Mount Fuji to Tokyo Bay.",
      duration: "60 minutes",
      highlights: [
  ...
  const vehicles = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1748621019980-8c9278b61974?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxUb3lvdGElMjBIaUFjZSUyMGx1eHVyeSUyMG1pbml2YW58ZW58MXx8fHwxNzU1NTk1OTUzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      guests: "6-9 guests",
    ...
    <div className="relative">
                ...
                <div className="bg-nippon-beige/30 p-6 rounded-lg border border-nippon-border space-y-4">
                  <div className="border-b border-nippon-gold/20 pb-3">
                    ...
                    <p className="text-luxury-sm text-nippon-gray font-sans">
                      Basic information for your Tokyo experience
                    </p>
                  </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              ...
              animation:
                "cinematicFloat 35s ease-in-out infinite alternate-reverse",
            }}
          ></div>
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(ellipse at 70% 30%, rgba(255, 215, 0, 0.3) 0%, rgba(212, 175, 55, 0.2) 40%, transparent 80%)",
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, transparent 15%, rgba(0, 0, 0, 0.4) 65%, rgba(0, 0, 0, 0.7) 100%)",
          }}
        ></div>
        ...
        >
          <div className="max-w-4xl text-center">
            <h1
              ...
              style={{
                textShadow:
                  "0 4px 32px rgba(0, 0, 0, 0.9), 0 2px 16px rgba(0, 0, 0, 0.8), 0 0 50px rgba(0, 0, 0, 0.7), 0 0 20px rgba(212, 175, 55, 0.4)",
              }}
            >
              Tokyo City Highlights
            </h1>
            ...
            <div className="space-y-12 max-w-3xl mx-auto">
              ...
              >
                A curated journey through Tokyo's vibrant contrasts — from
                timeless shrines to cutting-edge design.
              </p>
        ...
        >
          <div className="space-y-12">
            ...
            <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans max-w-3xl mx-auto">
              Discover Tokyo's many layers in a single, elegant day. From the
              historic streets of Asakusa to the sleek sophistication of Ginza,
              this tour blends culture, architecture, and atmosphere — with a
              flexible route tailored to your pace.
            </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto content-padding">
          ...
          <div className="text-center" data-scroll-reveal>
            <p className="text-luxury-base text-nippon-gray-light font-sans italic leading-relaxed max-w-2xl mx-auto">
              ...
              Flexible routing based on traffic, your interests, and optimal
              timing for each location.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-luxury-base text-nippon-gray font-sans">
                      First-time visitors, families, photographers
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-luxury-base text-nippon-gray font-sans">
                      Daily, advance booking required
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto content-padding">
          <div className="text-center space-y-8 mb-16" data-scroll-reveal>
            ...
            <p className="text-luxury-lg text-nippon-gray font-sans leading-relaxed max-w-2xl mx-auto">
              Real experiences from travelers who've discovered Tokyo with
              Nippon Imperial.
            </p>
          </div>
        ...
        >
          <div className="space-y-12">
            <div className="space-y-8">
              ...
              <p className="text-luxury-xl text-nippon-gray-light font-sans leading-relaxed max-w-2xl mx-auto">
                Our concierge team is available 24/7 to customize your Tokyo
