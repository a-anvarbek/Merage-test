              ...
              <div className="warm-white-card-secondary p-10 shadow-elegant">
                ...
                <div className="mb-12 luxury-fade-up">
                  ...
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <p className="text-luxury-lg text-nippon-gray mb-3 font-sans">
                        Available 24/7 for immediate assistance:
                      </p>
                      <p className="text-luxury-2xl text-nippon-black font-serif text-with-black-shadow">
                        +8 80 1234 7777
                      </p>
                    </div>
                  </div>
                ...
                <div className="mb-12 luxury-fade-up">
                  ...
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <p className="text-luxury-lg text-nippon-gray mb-3 font-sans">
                        For detailed requests and consultations:
                      </p>
                      <p className="text-luxury-2xl text-nippon-black font-serif text-with-black-shadow">
                        contact@nipponimperial.com
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-12 luxury-fade-up">
                  ...
                  <div className="flex items-start space-x-6">
                    ...
                    <div>
                      <p className="text-luxury-2xl text-nippon-black font-serif text-with-black-shadow mb-1">
                        Japan, Tokyo
                      </p>
                      <p className="text-luxury-2xl text-nippon-black font-serif text-with-black-shadow">
                        Ginza 1-1-1
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="luxury-fade-up">
                    <Input
                      ...
                      required
                    />
                    <p className="text-luxury-sm text-nippon-gray mt-2 font-sans">
                      (required)
                    </p>
                  </div>
                  ...
                  <div className="luxury-fade-up">
                    ...
                    >
                      ...
                      <SelectContent className="bg-nippon-warm-white border-2 border-nippon-gold shadow-luxury">
                        <SelectItem
                          value="general"
                          className="text-nippon-black hover:bg-nippon-gold hover:text-nippon-black font-sans text-luxury-lg py-3"
                        >
                          General
                        </SelectItem>
                        <SelectItem
                  ...
                  <div className="flex items-center space-x-4 luxury-fade-up">
                    ...
                    <label
                      ...
                      className="text-nippon-black font-sans text-luxury-lg"
                    >
