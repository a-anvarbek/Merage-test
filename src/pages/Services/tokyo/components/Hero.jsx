  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-nippon-black">
      ...
      <div className="absolute inset-0 z-0">
        {/* Main luxury chauffeur hero image */}
        <div
        ...
        {/* Secondary layered background for depth */}
        <ImageWithFallback
      ...
      <div className="relative z-20 text-center max-w-6xl mx-auto px-8" data-scroll-reveal>
        <div className="cinematic-entrance">
          <h1
            className="text-luxury-8xl lg:text-luxury-9xl text-nippon-warm-white font-serif mb-12 leading-none tracking-tight"
            style={{
              textShadow:
                '0 4px 16px rgba(0, 0, 0, 0.9), 0 2px 8px rgba(0, 0, 0, 0.8), 0 0 30px rgba(212, 175, 55, 0.3)'
            }}
          >
            Nippon Imperial
          </h1>
          ...
          <p
            className="text-luxury-2xl lg:text-luxury-3xl text-nippon-warm-white font-serif italic mb-16 leading-relaxed max-w-4xl mx-auto"
            style={{
