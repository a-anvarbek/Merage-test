...
import { MapPin, Users, CheckCircle, Star, Award, Clock, ArrowRight, Compass, Calendar, Car, Luggage, MapIcon, Camera, TreePine, Building2, Shield, Coffee, X, Phone, Mail, Globe, ChevronDown, ChevronUp, Calculator, CreditCard, Check, ChevronLeft, Mountain, Flower2, Palette, Cable, Ship, Waves, Flame, History, Anchor, Route, Sparkles, Crown, Send } from 'lucide-react';
...
export default function SignatureMultiDayTours() {
  ...
  const tours = [
    {
      ...
      summary: 'A week of iconic highlights — temples, tea gardens, and scenic rides on Japan\'s bullet train. Ideal for first-time luxury travelers.',
      highlights: ['Bullet Train Experience', 'Kyoto Temple Districts', 'Hakone Hot Springs', 'Tokyo Modern Culture'],
      duration: '7 Days / 6 Nights',
      destinations: '3 Major Cities',
      image: "https://images.unsplash.com/photo-1681862417657-e5b9bfefea53?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxUb2t5byUyMEt5b3RvJTIwZ29sZGVuJTIwcm91dGUlMjBKYXBhbiUyMHRyYXZlbHxlbnwxfHx8fDE3NTU3NTM3NTZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      id: 'essence-japan',
      name: 'The 10-Day Essence of Japan',
      route: 'Tokyo → Mt. Fuji → Kyoto → Nara',
      summary: 'A deeper immersion into Japan\'s spiritual sites and artistic heritage — with refined pacing and handpicked cultural experiences.',
      highlights: ['Mt. Fuji Views', 'Nara Deer Park', 'Spiritual Temples', 'Cultural Workshops'],
      duration: '10 Days / 9 Nights',
      destinations: '4 UNESCO Sites',
      image: "https://images.unsplash.com/photo-1719239488015-fc29a74ab22c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxKYXBhbiUyMGVzc2VuY2UlMjB0ZW1wbGVzJTIwZ2FyZGVucyUyMGN1bHR1cmFsfGVufDF8fHx8MTc1NTc1Mzc2M3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      id: 'imperial-circle',
      name: 'The 14-Day Imperial Circle',
      route: 'Tokyo → Hakone → Kyoto → Hiroshima → Osaka',
      summary: 'A grand, privately guided voyage through ancient capitals and modern cities, bridging samurai history with Japanese innovation.',
      highlights: ['Imperial Palaces', 'Hiroshima Peace Memorial', 'Osaka Culinary Scene', 'Private Guide Access'],
      duration: '14 Days / 13 Nights',
      destinations: '5 Imperial Cities',
      image: "https://images.unsplash.com/photo-1728200697459-b9296ccf9773?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxKYXBhbiUyMGltcGVyaWFsJTIwcGFsYWNlJTIwY3VsdHVyYWwlMjBoZXJpdGFnZXxlbnwxfHx8fDE3NTU3NTM3NTl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    }
  ];
  ...
  function RatingStars({ value }) {
    ...
    for (let i = 0; i < (value || 0); i++) {
      stars.push(<Star key={i} className="w-4 h-4 fill-nippon-gold text-nippon-gold" />);
    }
    return <div className="flex items-center space-x-1">{stars}</div>;
  }

  function TourBadge({ children }) {
    return <Badge className="bg-nippon-gold text-nippon-black text-luxury-xs">{children}</Badge>;
  }

  function DecorativeDivider() {
    return <div className="h-px w-48 mb-16 bg-gradient-to-r from-transparent via-nippon-gold to-transparent shadow-gold mx-auto" />;
  }
  ...
  return (
    <div className="relative">
              ...
              <div className="px-6 py-4">
                <DialogHeader>
                  ...
                  <DialogDescription className="text-luxury-sm text-nippon-gray font-sans text-left">
                    Share your travel vision and we'll craft the perfect itinerary
                  </DialogDescription>
                </DialogHeader>
                  ...
                  <div className="mt-4 bg-nippon-gold/10 px-4 py-3 rounded border-l-3 border-nippon-gold">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <span className="text-luxury-sm text-nippon-black font-serif">{formData.selectedTour}</span>
                          <span className="text-luxury-xs text-nippon-gray font-sans ml-2">• Multi-Day Experience</span>
                        </div>
                      </div>
                      <Button
                        type="button"
              ...
              <form onSubmit={handleFormSubmit} className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="bg-nippon-beige/30 p-6 rounded-lg border border-nippon-border space-y-4">
                  <div className="border-b border-nippon-gold/20 pb-3">
                    ...
                    <p className="text-luxury-sm text-nippon-gray font-sans">How can our concierge team reach you?</p>
                  </div>
                ...
                <div className="bg-nippon-warm-white/80 p-6 rounded-lg border border-nippon-border space-y-4">
                  <div className="border-b border-nippon-gold/20 pb-3">
                    ...
                    <p className="text-luxury-sm text-nippon-gray font-sans">Help us understand your perfect journey</p>
                  </div>

                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="travelDates" className="text-nippon-black font-serif">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="guestCount" className="text-nippon-black font-serif">
                        Number of Travelers
                      </Label>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="travelStyle" className="text-nippon-black font-serif">
                      Travel Style / Pace
                    </Label>
                    <Select onValueChange={(value) => setFormData({...formData, travelStyle: value})}>
                      <SelectTrigger className="enhanced-luxury-input">
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="active">Active & Comprehensive</SelectItem>
                        <SelectItem value="cultural">Cultural Immersion Focus</SelectItem>
                        <SelectItem value="luxury">Ultra-Luxury Experience</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
                ...
                <div className="bg-nippon-beige/30 p-6 rounded-lg border border-nippon-border space-y-4">
                  <div className="border-b border-nippon-gold/20 pb-3">
                    ...
                    <p className="text-luxury-sm text-nippon-gray font-sans">Tell us about your dream trip to Japan</p>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="destinationsOfInterest" className="text-nippon-black font-serif">
                      Destinations of Interest
                    </Label>
                    <Textarea
                      id="destinationsOfInterest"
                      value={formData.destinationsOfInterest}
                      onChange={(e) => setFormData({...formData, destinationsOfInterest: e.target.value})}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="specialRequests" className="text-nippon-black font-serif">
                ...
                {formData.selectedTour && (
                  <div className="bg-nippon-gold/5 p-6 rounded-lg border-2 border-nippon-gold/20 space-y-3">
                    ...
                    <div className="bg-nippon-warm-white p-4 rounded border border-nippon-gold/30">
                      <Label className="text-luxury-sm text-nippon-black font-serif">Journey Type</Label>
                      <p className="text-luxury-sm text-nippon-black font-sans mt-1">{formData.selectedTour}</p>
                      {formData.selectedTour === 'Custom Itinerary' && (
                        <p className="text-luxury-xs text-nippon-gray font-sans mt-2 italic">
                          Our specialists will create a completely bespoke experience based on your preferences
                        </p>
                      )}
                    </div>
                  </div>
                ...
                <div className="pt-4 space-y-3">
                  ...
                  >
                    ...
                    <span className="relative flex items-center justify-center space-x-2">
                      ...
                      <span className="tracking-wider font-medium">Submit Your Request</span>
                      <ArrowRight className="w-4 h-4" />
                    </span>
                  </Button>

                  <p className="text-luxury-xs text-nippon-gray font-sans text-center">
                    Our concierge team will respond within 24 hours to begin planning your journey. No commitment required.
                  </p>
                </div>
              </form>
            </div>
          ...
          <div className="max-w-4xl text-center">
            ...
            <div className="space-y-12 max-w-3xl mx-auto">
              <p className="text-luxury-2xl text-nippon-warm-white font-serif italic leading-relaxed text-center"
                ...
                Expertly crafted itineraries across Japan's most iconic regions — with luxury, depth, and cultural connection at every turn.
              </p>

              <div className="grid grid-cols-3 gap-8 py-8">
                <div className="text-center">
                  <div className="text-luxury-3xl text-nippon-gold font-serif mb-2">3</div>
                  <div className="text-luxury-sm text-nippon-warm-white font-sans">Curated Journeys</div>
                </div>
                <div className="text-center">
                  <div className="text-luxury-3xl text-nippon-gold font-serif mb-2">14</div>
                  <div className="text-luxury-sm text-nippon-warm-white font-sans">Days Maximum</div>
                </div>
                <div className="text-center">
                  <div className="text-luxury-3xl text-nippon-gold font-serif mb-2">∞</div>
                  <div className="text-luxury-sm text-nippon-warm-white font-sans">Custom Options</div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-8 max-w-3xl mx-auto">
              <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans">
                Each of our multi-day tours is a curated experience — balancing iconic landmarks with off-the-beaten-path immersion.
              </p>

              <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans">
                Whether you're exploring for 7, 10, or 14 days, we design your route with precision, purpose, and personalization.
              </p>

              <p className="text-luxury-lg text-nippon-gold font-serif italic">
                Prefer a fully tailored itinerary? Our concierge will craft one from scratch — built around your rhythm, interests, and pace.
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-8">
              <div className="text-center">
                ...
                <div className="text-luxury-sm text-nippon-black font-serif">Luxury Accommodations</div>
              </div>
              <div className="text-center">
                <Route className="w-8 h-8 text-nippon-gold mx-auto mb-3" />
                <div className="text-luxury-sm text-nippon-black font-serif">Expert Routing</div>
              </div>
              <div className="text-center">
                <Users className="w-8 h-8 text-nippon-gold mx-auto mb-3" />
                <div className="text-luxury-sm text-nippon-black font-serif">Private Guides</div>
              </div>
              <div className="text-center">
                <Sparkles className="w-8 h-8 text-nippon-gold mx-auto mb-3" />
                <div className="text-luxury-sm text-nippon-black font-serif">Exclusive Access</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Set Tours Section */}
      <section id="tour-options" className="relative bg-nippon-black section-padding overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto content-padding">
          <div className="text-center space-y-8 mb-16" data-scroll-reveal>
            ...
            <p className="text-luxury-xl text-nippon-gray-light font-sans leading-relaxed max-w-2xl mx-auto">
              Choose from our expertly designed multi-day experiences, each crafted for different depths of exploration.
            </p>
          </div>
            ...
            {tours.map((tour, index) => (
              ...
              >
                ...
                <CardContent className="p-6 space-y-4">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-luxury-sm text-nippon-black font-serif">Journey Highlights:</h4>
                    <div className="grid grid-cols-2 gap-2">
                      {tour.highlights.map((highlight, idx) => (
                        <div key={idx} className="flex items-center space-x-2">
                          <CheckCircle className="w-3 h-3 text-nippon-gold flex-shrink-0" />
                          <span className="text-luxury-xs text-nippon-gray font-sans">{highlight}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <span className="relative flex items-center justify-center space-x-2 text-nippon-gold group-hover:text-nippon-black">
                      <span className="tracking-wider font-medium">Request This Journey</span>
                      <ArrowRight className="w-4 h-4" />
                    </span>
                  </Button>
                </CardContent>
          ...
          <div className="bg-nippon-gold/5 p-12 rounded-lg border-2 border-nippon-gold/20 space-y-8">
            <div className="space-y-6">
              ...
              <p className="text-luxury-xl text-nippon-gray leading-relaxed max-w-2xl mx-auto font-sans">
                Let our Japan travel specialists create a private journey just for you — complete with accommodations, guides, rail passes, luxury transport, and exclusive access.
              </p>
            </div>
            ...
            >
              ...
              <span className="relative flex items-center space-x-3">
                ...
                <span className="tracking-wider font-medium">Begin Your Custom Consultation</span>
                <ArrowRight className="w-4 h-4 transform group-hover:translate-x-1 transition-transform duration-300" />
              </span>
            </Button>

            <p className="text-luxury-sm text-nippon-gray-light font-sans italic">
              Need inspiration? Our travel specialists will guide you through all possibilities.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-6xl mx-auto content-padding">
          <div className="text-center space-y-8 mb-16" data-scroll-reveal>
            ...
            <p className="text-luxury-lg text-nippon-gray-light font-sans leading-relaxed max-w-2xl mx-auto">
              Discover how our multi-day experiences create lasting memories for discerning travelers.
            </p>
          </div>
      ...
      <section className="relative bg-nippon-warm-white py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-luxury-lg font-serif text-nippon-black">Contact</h3>
              <p className="text-luxury-sm text-nippon-gray mt-2">Email: concierge@nippon.example</p>
              <p className="text-luxury-sm text-nippon-gray">Phone: +81 3-0000-0000</p>
            </div>
            <div>
              <h3 className="text-luxury-lg font-serif text-nippon-black">Quick Links</h3>
              <ul className="mt-3 space-y-2 text-luxury-sm text-nippon-gray">
                <li><a href="#tour-options" className="underline">Signature Journeys</a></li>
                <li><a href="#contact" className="underline">Contact Concierge</a></li>
                <li><a href="#faq" className="underline">FAQ</a></li>
              </ul>
            </div>
            <div>
              <h3 className="text-luxury-lg font-serif text-nippon-black">Follow</h3>
              <p className="text-luxury-sm text-nippon-gray mt-2">Instagram • Facebook • LinkedIn</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-nippon-black py-8 text-center">
        <div className="max-w-4xl mx-auto text-luxury-sm text-nippon-gray">
          © {new Date().getFullYear()} Nippon Imperial Tours — All rights reserved.
        </div>
      </footer>
    </div>
  );
