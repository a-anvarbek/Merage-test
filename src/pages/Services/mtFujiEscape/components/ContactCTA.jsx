...
const handleContactMethod = (method) => {
  if (method === "Begin Your Journey") {
    // Real implementatsiyada bu booking widget ochadi
    window.open(
      'mailto:concierge@nipponimperial.com?subject=Journey Consultation Request',
      '_blank'
    );
  } else if (method === "Written Inquiries") {
    window.open(
      'mailto:concierge@nipponimperial.com?subject=Detailed Planning Request',
      '_blank'
    );
  ...
  return (
    <section id="contact" className="relative bg-nippon-black overflow-hidden">
      {/* Sophisticated background imagery */}
      <div className="absolute inset-0">
        <div 
          className="absolute inset-0 w-full h-full bg-cover bg-center bg-no-repeat opacity-15"
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1578910537786-301723c3382d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxUb2t5byUyMHNreWxpbmUlMjBuaWdodCUyMGx1eHVyeSUyMGNpdHlzY2FwZXxlbnwxfHx8fDE3NTUyNDg0MDN8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral')`,
