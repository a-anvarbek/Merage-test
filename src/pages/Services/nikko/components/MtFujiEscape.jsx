import { MapPin, Users, CheckCircle, Star, Award, Clock, ArrowRight, Compass, Calendar, Car, Luggage, MapIcon, Camera, TreePine, Building2, Shield, Coffee, X, Phone, Mail, Globe, ChevronDown, ChevronUp, Calculator, CreditCard, Check, ChevronLeft, Mountain, Flower2 } from 'lucide-react';
...
import mtFujiNightImage from 'figma:asset/fa52018f1cbc6d92c05a82ee73416ea87e0e6681.png';
...
export function MtFujiEscape() {
  ...
  const itineraryHighlights = [
    {
      ...
      detailedDescription: "Experience Japan's most sacred mountain up close at 2,300 meters above sea level. Walk through pristine forest trails, breathe the crisp alpine air, and enjoy unparalleled views across the Fuji Five Lakes region. This mid-mountain station offers the perfect balance of accessibility and authentic mountain atmosphere.",
      duration: "90 minutes",
      highlights: ["Alpine Forest Trails", "Mountain Observatory", "Sacred Mountain Views", "Fresh Mountain Air"],
      image: "https://images.unsplash.com/photo-1736246147574-ea1ed1ddbaca?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxNdCUyMEZ1amklMjA1dGglMjBzdGF0aW9uJTIwbW91bnRhaW58ZW58MXx8fHwxNzU1NjU1MzgzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      icon: Coffee,
      title: "Oshino Hakkai",
      description: "A peaceful village of crystal-clear spring-fed ponds.",
      detailedDescription: "Discover this enchanting village where eight pristine spring-fed ponds create a mystical landscape. These crystal-clear waters, filtered through Mt. Fuji's volcanic rock over decades, maintain a constant temperature year-round. Stroll through this UNESCO World Heritage site and experience the pure tranquility of rural Japan.",
      duration: "75 minutes",
      highlights: ["Crystal Spring Ponds", "Traditional Village Architecture", "Sacred Water Sources", "Mountain Views"],
      image: "https://images.unsplash.com/photo-1727803778186-b76e67ff81c2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxPc2hpbm8lMjBIYWtrYWklMjB2aWxsYWdlJTIwcG9uZHMlMjBKYXBhbnxlbnwxfHx8fDE3NTU2NTUzNzh8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      icon: Camera,
      title: "Chureito Pagoda",
      description: "Photograph Mt. Fuji from a hilltop shrine framed by cherry trees or autumn leaves.",
      detailedDescription: "Climb to one of Japan's most photographed viewpoints, where the five-story Chureito Pagoda creates a perfect frame for Mt. Fuji. This iconic spot offers breathtaking seasonal beauty - cherry blossoms in spring and vibrant maple leaves in autumn - making it a photographer's paradise and spiritual retreat.",
      duration: "60 minutes",
      highlights: ["Iconic Mt. Fuji Views", "Five-Story Pagoda", "Seasonal Beauty", "Photography Paradise"],
      image: "https://images.unsplash.com/photo-1574236170880-fbbca132d83d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxDaHVyZWl0byUyMFBhZ29kYSUyME10JTIwRnVqaSUyMGF1dHVtbnxlbnwxfHx8fDE3NTU2NTUzNzV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      icon: Flower2,
      title: "Oishi Park",
      description: "Lakeside flower gardens with stunning Fuji views.",
      detailedDescription: "Wander through beautifully manicured flower gardens that bloom in vibrant seasonal displays, all set against the dramatic backdrop of Mt. Fuji and Lake Kawaguchiko. This peaceful park offers perfect spots for contemplation, photography, and experiencing the harmonious relationship between cultivated beauty and natural majesty.",
      duration: "45 minutes",
      highlights: ["Seasonal Flower Gardens", "Lake Kawaguchiko Views", "Mt. Fuji Backdrop", "Peaceful Walking Paths"],
      image: "https://images.unsplash.com/photo-1719284633229-e583e5535457?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxPaXNoaSUyMFBhcmslMjBNdCUyMEZ1amklMjBmbG93ZXJzfGVufDF8fHx8MTc1NTY1NTM4Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      icon: MapPin,
      title: "Lake Kawaguchiko",
      description: "Leisurely walk, optional cable car ride, and lunch by the water.",
      detailedDescription: "Experience the serene beauty of Mt. Fuji's most accessible lake. Take a leisurely waterfront stroll, enjoy an optional cable car ride for elevated panoramic views, and savor a peaceful lunch with the mountain's reflection dancing on the lake's surface. This is where tranquility and natural beauty converge.",
      duration: "2.5 hours",
      highlights: ["Lakeside Promenade", "Cable Car Experience", "Waterfront Dining", "Mountain Reflections"],
      image: "https://images.unsplash.com/photo-1556032818-683e550a2c14?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxNdCUyMEZ1amklMjBMYWtlJTIwS2F3YWd1Y2hpa28lMjBjaGVycnklMjBibG9zc29tc3xlbnwxfHx8fDE3NTU2NTUzNzF8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      icon: Building2,
      title: "Iyashino Sato",
      description: "Thatched-roof village with artisan shops and a window into rural tradition.",
      detailedDescription: "Step back in time at this beautifully preserved traditional village featuring authentic thatched-roof farmhouses. Browse local artisan workshops, witness traditional crafts being made, and gain insight into Japan's rural heritage. This living museum offers a peaceful escape from modernity while honoring centuries-old traditions.",
      duration: "90 minutes",
      highlights: ["Traditional Thatched Houses", "Artisan Workshops", "Cultural Heritage", "Rural Japan Experience"],
      image: "https://images.unsplash.com/photo-1659090833777-fcdb820ce4e8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxJeWFzaGlubyUyMFNhdG8lMjB0aGF0Y2hlZCUyMHJvb2YlMjB2aWxsYWdlfGVufDF8fHx8MTc1NTY1NTM5MHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    },
    {
      icon: TreePine,
      title: "Aokigahara Forest (Optional)",
      description: "Explore the Wind or Ice Caves along the edge of this storied woodland.",
      detailedDescription: "Venture to the edge of Japan's most mysterious forest to explore remarkable natural ice and wind caves formed by ancient lava flows. These geological wonders maintain cool temperatures year-round and offer a unique perspective on Mt. Fuji's volcanic history while respecting the forest's profound cultural significance.",
      duration: "60 minutes",
      highlights: ["Natural Ice Caves", "Wind Cave Formation", "Volcanic History", "Ancient Forest Edge"],
      image: "https://images.unsplash.com/photo-1736418629900-ce9e8ff526ad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxBb2tpZ2FoYXJhJTIwZm9yZXN0JTIwSmFwYW4lMjBjYXZlc3xlbnwxfHx8fDE3NTU2NTUzOTR8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
    }
  ];
  ...
  return (
    <div className="relative">
              ...
              <form onSubmit={handleFormSubmit} className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="bg-nippon-beige/30 p-6 rounded-lg border border-nippon-border space-y-4">
                  <div className="border-b border-nippon-gold/20 pb-3">
                    ...
                    <p className="text-luxury-sm text-nippon-gray font-sans">Basic information for your Mt. Fuji experience</p>
                  </div>
      ...
      {/* Hero Section - Enhanced with New Mt. Fuji Night Image */}
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          {/* Main Background - Mt. Fuji Night Image */}
          <ImageWithFallback
          ...
          {/* Subtle overlay to enhance the night atmosphere */}
          <div 
            className="absolute inset-0 w-full h-full opacity-20"
            style={{
              background: 'radial-gradient(ellipse at 30% 70%, rgba(212, 175, 55, 0.15) 0%, rgba(26, 26, 45, 0.1) 40%, transparent 80%)',
        ...
        {/* Subtle golden glow effects to complement the starry night */}
        <div className="absolute top-1/3 right-1/4 w-96 h-96 rounded-full bg-nippon-gold opacity-5 blur-3xl z-10"></div>
          ...
          <div className="max-w-4xl text-center">
            ...
            <div className="space-y-12 max-w-3xl mx-auto">
              <p className="text-luxury-2xl text-nippon-warm-white font-serif italic leading-relaxed text-center"
                ...
                A day of scenic beauty, tranquil villages, and cultural connection — curated for quiet luxury and personalized flow.
              </p>
        ...
        <div className="relative z-10 max-w-4xl mx-auto content-padding text-center" data-scroll-reveal>
          <div className="space-y-12">
            ...
            <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans max-w-3xl mx-auto">
              Discover Mt. Fuji's majesty through a carefully curated journey from Tokyo. From ancient shrines to pristine lakes, this tour blends natural wonder with cultural depth — flexible routing tailored to weather and your interests.
            </p>
        ...
        <div className="relative z-10 max-w-7xl mx-auto content-padding">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {itineraryHighlights.map((highlight, index) => (
              <div
                key={index}
                className={`group relative bg-nippon-warm-white shadow-luxury hover:shadow-luxury-hover transition-all duration-500 overflow-hidden border-l-4 border-nippon-gold cursor-pointer ${expandedItinerary === index ? 'col-span-full md:col-span-2' : ''}`}
                data-scroll-reveal
          ...
          <div className="text-center" data-scroll-reveal>
            <p className="text-luxury-base text-nippon-gray-light font-sans italic leading-relaxed max-w-2xl mx-auto">
              ...
              Flexible routing based on weather conditions, seasonal access, and your interests for optimal Mt. Fuji viewing.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-luxury-base text-nippon-gray font-sans">Nature lovers, photographers, cultural enthusiasts</p>
                  </div>
                </div>
      ...
      <section id="vehicle-selection" className="relative bg-nippon-black section-padding overflow-hidden">
        <div className="relative z-10 max-w-7xl mx_auto content-padding">
          <div className="text-center space-y-8 mb-16" data-scroll-reveal>
            <h2 className="text-luxury-5xl text-nippon-warm-white font-serif leading-tight">
