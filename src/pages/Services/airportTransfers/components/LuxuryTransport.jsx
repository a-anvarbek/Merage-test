import { MapPin, CheckCircle, ArrowRight, Clock, Star, Award, Car, Shield, Route, Users, Crown, Zap } from 'lucide-react';
  ...
  const highlights = [
    {
      icon: Car,
      title: "Premium Fleet",
      description: "Mercedes S-Class, V-Class, and Toyota Alphard executive vehicles",
  ...
  const processSteps = [
    {
      ...
      description: "Tell us your pickup and drop-off locations, preferred vehicle type, and any special requirements for your journey.",
      icon: MapPin,
    ...
    },
    {
      ...
      description: "Your concierge confirms availability, route optimization, and vehicle specifications, ensuring every detail meets your standards.",
      icon: Star,
    ...
    },
    {
      ...
      description: "Relax in supreme comfort while your professional chauffeur handles navigation, timing, and all transportation logistics.",
      icon: CheckCircle,
...
const handleFormSubmit = (e) => {
  ...
  return (
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div 
            ...
            style={{
              background: 'radial-gradient(ellipse at 30% 40%, rgba(212, 175, 55, 0.2) 0%, transparent 60%)',
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-8" data-scroll-reveal>
          <div className="max-w-4xl text-center">
            ...
            <div className="inline-flex items-center space-x-2 bg-nippon-gold/15 backdrop-blur-sm border border-nippon-gold/40 px-6 py-2 mb-12">
              ...
              <span className="text-nippon-gold font-serif text-luxury-sm tracking-wider">Trusted by Diplomatic Missions</span>
            </div>
            ...
            <div className="space-y-6 mb-16">
              <p className="text-luxury-xl text-nippon-warm-white font-sans leading-relaxed max-w-2xl mx-auto"
                ...
                Experience Japan's finest luxury transport — where every mile is a testament to excellence.
              </p>
              ...
              <div className="flex justify-center items-center space-x-8 text-nippon-gold">
                <div className="text-center">
                  ...
                  <span className="text-luxury-sm font-sans opacity-90">Premium Vehicles</span>
                </div>
                <div className="w-px h-8 bg-nippon-gold/40"></div>
                <div className="text-center">
                  <span className="block text-luxury-lg font-serif">24/7</span>
                  <span className="text-luxury-sm font-sans opacity-90">Service Available</span>
                </div>
                <div className="w-px h-8 bg-nippon-gold/40"></div>
                <div className="text-center">
                  <span className="block text-luxury-lg font-serif">15min</span>
                  <span className="text-luxury-sm font-sans opacity-90">Response Time</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              >
                ...
                <span className="relative flex items-center space-x-3">
                  <span className="tracking-wider font-medium">Arrange Your Transport</span>
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-luxury-xl text-nippon-black font-serif italic leading-relaxed">
                  Luxury transport with Nippon Imperial is more than getting from A to B — it's a seamless experience that blends comfort, privacy, and impeccable service.
                </p>
                
                <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans">
                  Our fleet of premium vehicles and professional chauffeurs ensures every ride is as memorable as your destination. From airport transfers to full-day excursions, every journey is executed with precision and elegance, maintaining the highest standards of discretion and punctuality.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="transport-form" className="relative bg-nippon-warm-white section-padding overflow-hidden">
        {/* Background pattern */}
        <div className="absolute inset-0 opacity-2">
          <div 
            className="w-full h-full"
        ...
        <div className="relative z-10 max-w-4xl mx-auto content-padding">
          <div className="text-center mb-16" data-scroll-reveal>
            ...
            <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans max-w-2xl mx-auto">
              Share your transport requirements and we'll ensure every journey exceeds your expectations.
            </p>
          </div>
          ...
          <div className="bg-nippon-white shadow-luxury p-12" data-scroll-reveal>
            <form onSubmit={handleFormSubmit} className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="passengers" className="text-nippon-black font-sans">Number of Passengers *</Label>
                  <Input
                    id="passengers"
                    type="number"
                    min="1"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="pickup" className="text-nippon-black font-sans">Pickup Location *</Label>
                  <Input
                    id="pickup"
                    type="text"
                    required
                ...
                <div className="space-y-2">
                  <Label htmlFor="dropoff" className="text-nippon-black font-sans">Drop-off Location *</Label>
                  <Input
                    id="dropoff"
                    type="text"
                    required
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="service-date" className="text-nippon-black font-sans">Service Date *</Label>
                  <Input
                    id="service-date"
                    type="date"
                    required
                ...
                <div className="space-y-2">
                  <Label htmlFor="service-time" className="text-nippon-black font-sans">Service Time *</Label>
                  <Input
                    id="service-time"
                    type="time"
                    required
              ...
              <div className="space-y-2">
                <Label htmlFor="vehicle-preference" className="text-nippon-black font-sans">Vehicle Preference</Label>
                <Input
              ...
              <div className="space-y-2">
                <Label htmlFor="special-requests" className="text-nippon-black font-sans">Special Requests & Requirements</Label>
                <Textarea
                  id="special-requests"
              ...
              <div className="pt-6">
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center space-x-3">
                    ...
                    <span className="tracking-wider font-medium">Submit Transport Request</span>
                    <ArrowRight className="w-5 h-5 transform group-hover:translate-x-1 transition-transform duration-300" />
                  </span>
                </Button>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-2">
                  <p className="text-nippon-black font-sans text-luxury-sm leading-relaxed">
                    <strong>Immediate Confirmation:</strong> You'll receive a response within 15 minutes with your booking reference and vehicle details.
                  </p>
                  <p className="text-nippon-gray font-sans text-luxury-xs leading-relaxed">
                    Our transport team will coordinate all logistics and send chauffeur contact information 1 hour before pickup.
                  </p>
                </div>
              </div>
            </div>
