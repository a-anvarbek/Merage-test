...
import { MapPin, CheckCircle, ArrowRight, Clock, Star, Award, Hotel, Mountain, Building, Users } from 'lucide-react';
import { Button } from './ui/button';
import { Input } from './ui/input';
import { Textarea } from './ui/textarea';
import { Label } from './ui/label';
import { ImageWithFallback } from './figma/ImageWithFallback';
import luxuryPenthouseImage from 'figma/e7210fddee657827c318f9187383fdf564c08e3f.png';
import ryokanImage from 'figma/193e56f8a0a5dc7b391435431609fbcea84b5176.png';
import cityHotelImage from 'figma/e7210fddee657827c318f9187383fdf564c08e3f.png';
import vipServicesImage from 'figma/740031435016cc2ff4c721aff2f73de9918ab347.png';
import historicMachiyaImage from 'figma/43be00189321411be76f95a109160bd875f25f47.png';
...
export default function AccommodationReservations() {
  const highlights = [
    {
      ...
      description: "Exclusive mountain retreats with centuries-old hospitality traditions",
      image: ryokanImage,
    ...
    },
    {
      ...
      description: "Restored cultural treasures in Kyoto's most exclusive districts",
  ...
  const scrollToForm = () => {
    const el = document.getElementById('accommodation-form');
    ...
    <div className="relative">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(45deg, transparent 20%, rgba(212, 175, 55, 0.06) 40%, transparent 60%)',
          ...
          <div
            ...
            style={{
              background: 'radial-gradient(circle at 30% 40%, rgba(212, 175, 55, 0.12) 0%, transparent 60%)',
        ...
        <div className="relative z-20 max-w-6xl mx-auto px-8" data-scroll-reveal="">
          <div className="max-w-4xl text-center">
            ...
            <div className="inline-flex items-center space-x-2 bg-nippon-gold/10 backdrop-blur-sm border border-nippon-gold/30 px-6 py-2 mb-12">
              ...
              <span className="text-nippon-gold font-serif text-luxury-sm tracking-wider">Preferred by Fortune 500 Executives</span>
            </div>

            {/* Main Tagline */}
            <h1
              className="text-luxury-7xl lg-luxury-8xl text-nippon-warm-white font-serif mb-16 leading-none tracking-tight"
              style={{
            ...
            <div className="space-y-6 mb-16">
              ...
              >
                Access Japan's most exclusive properties — from mountain sanctuaries to imperial penthouses.
              </p>
              ...
              <div className="flex justify-center items-center space-x-8 text-nippon-gold">
                <div className="text-center">
                  ...
                  <span className="text-luxury-sm font-sans opacity-80">Exclusive Properties</span>
                </div>
                <div className="w-px h-8 bg-nippon-gold/30"></div>
                <div className="text-center">
                  <span className="block text-luxury-lg font-serif">4.9</span>
                  <span className="text-luxury-sm font-sans opacity-80">Michelin Keys</span>
                </div>
                <div className="w-px h-8 bg-nippon-gold/30"></div>
                <div className="text-center">
                  <span className="block text-luxury-lg font-serif">24/7</span>
                  <span className="text-luxury-sm font-sans opacity-80">Concierge Service</span>
                </div>
              </div>
            </div>
            ...
            <div>
              <Button
                ...
                className="group relative overflow-hidden bg-transparent border-2 border-nippon-gold text-nippon-gold hover-nippon-black font-sans text-luxury-base px-10 py-4 transition-all duration-500 shadow-gold hover-gold-hover transform hover:-translate-y-2 hover-nippon-gold luxury-button-gold"
                style={{
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-luxury-xl text-nippon-black font-serif italic leading-relaxed">
                  At Nippon Imperial, accommodation is more than a place to sleep — it is the backdrop to your Japanese story.
                </p>

                <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans">
                  From private ryokan suites hidden in mountain valleys to modern penthouses overlooking the city lights, every stay is curated with
                  precision, discretion, and cultural authenticity. Our relationships with select properties ensure access to rooms, rates, and
                  experiences often unavailable elsewhere.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8" data-scroll-reveal="">
            {highlights.map((highlight, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group bg-nippon-white shadow-luxury hover-luxury-hover transition-all duration-500 transform hover:-translate-y-2 overflow-hidden"
                ...
                >
                  ...
                  <div className="relative aspect-[4/3] overflow-hidden">
                    ...
                    <div className="absolute top-4 right-4">
                      <div className="w-12 h-12 bg-nippon-gold/90 backdrop-blur-sm flex items-center justify-center shadow-gold">
                        <Icon className="w-6 h-6 text-nippon-black" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-8 text-center space-y-4">
                    {/* Title */}
                    <h3 className="text-luxury-xl text-nippon-black font-serif leading-tight">{highlight.title}</h3>

                    {/* Description */}
                    <p className="text-nippon-gray font-sans text-luxury-base leading-relaxed">{highlight.description}</p>

                    {/* Premium */}
                    {highlight.premium && <p className="text-nippon-gold font-serif text-luxury-sm">{highlight.premium}</p>}
                  </div>
                </div>
              );
            })}
      ...
      <section className="relative bg-nippon-black section-padding overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto content-padding">
          {/* Section Header */}
          <div className="text-center mb-20" data-scroll-reveal="">
            <h2 className="text-luxury-4xl text-nippon-warm-white font-serif leading-tight mb-8">How It Works</h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="mx-auto w-14 h-14 bg-nippon-warm-white/10 backdrop-blur-sm flex items-center justify-center">
                    <StepIcon className="w-7 h-7 text-nippon-gold" />
                  </div>

                  {/* Title */}
                  <h3 className="text-luxury-2xl text-nippon-warm-white font-serif leading-tight">{step.title}</h3>

                  {/* Description */}
                  <p className="text-nippon-gray-light font-sans text-luxury-base leading-relaxed max-w-sm mx-auto">{step.description}</p>

                  {/* Timeframe */}
                  {step.timeframe && <p className="text-nippon-gold font-serif text-luxury-sm">{step.timeframe}</p>}
                </div>
              );
            })}
          </div>
      ...
      <section id="accommodation-form" className="relative bg-nippon-warm-white section-padding overflow-hidden">
        {/* Background pattern */}
        <div className="absolute inset-0 opacity-2">
          <div
            className="w-full h-full"
        ...
        <div className="relative z-10 max-w-4xl mx-auto content-padding">
          <div className="text-center mb-16" data-scroll-reveal="">
            <h2 className="text-luxury-4xl text-nippon-black font-serif leading-tight mb-8">Let Us Arrange Your Perfect Stay</h2>
            <p className="text-luxury-lg text-nippon-gray leading-relaxed font-sans max-w-2xl mx-auto">
              Share your vision and we'll curate accommodation options that perfectly align with your Japanese journey.
            </p>
          </div>
          ...
          <div className="bg-nippon-white shadow-luxury p-12" data-scroll-reveal="">
            <form onSubmit={handleFormSubmit} className="space-y-8">
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="email" className="text-nippon-black font-sans">
                    Email *
                  </Label>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="phone" className="text-nippon-black font-sans">
                    Phone (Optional)
                  </Label>
                  <Input id="phone" type="tel" className="luxury-input" placeholder="+1 (555) 123-4567" />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="guests" className="text-nippon-black font-sans">
                    Number of Guests *
                  </Label>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <Label htmlFor="checkin" className="text-nippon-black font-sans">
                    Check-in Date *
                  </Label>
                  <Input id="checkin" type="date" required className="luxury-input" />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="checkout" className="text-nippon-black font-sans">
                    Check-out Date *
                  </Label>
                  <Input id="checkout" type="date" required className="luxury-input" />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="requests" className="text-nippon-black font-sans">
              ...
              <div className="pt-6">
                ...
                >
                  ...
                  <span className="relative flex items-center justify-center space-x-3">
                    ...
                    <span className="tracking-wider font-medium">Submit Accommodation Request</span>
                    <ArrowRight className="w-5 h-5 transform group-hover-x-1 transition-transform duration-300" />
                  </span>
                </Button>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-2">
                  <p className="text-nippon-black font-sans text-luxury-sm leading-relaxed">
                    <strong>Immediate Confirmation:</strong> You'll receive a personalized response within 2 hours with your request ID and next steps.
                  </p>
                  <p className="text-nippon-gray font-sans text-luxury-xs leading-relaxed">
                    Our concierge team will follow up with curated accommodation options within 24 hours.
                  </p>
                </div>
              </div>
            </div>
