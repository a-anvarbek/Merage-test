...
export function Concierge() {
  const services = [
    {
      icon: MapPin,
      title,
      description, ryokan and hidden retreats, aligned precisely with your rhythm and privacy.",
      image=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      cta},
    {
      icon: Crown,
      title,
      description, Michelin-level kaiseki and intimate bars curated to your palate and occasion.",
      image=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      cta},
    {
      icon: Car,
      title,
      description, minivans and luxury transfers arranged at any time, ensuring your journey is as comfortable as your destination.",
      image,
      cta},
    {
      icon: Calendar,
      ...
      cta},
    {
      icon: Sparkles,
      title,
      description, helicopters and serene spa escapes arranged around your moments, reflecting the height of exclusivity and possibility.",
      image=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
      cta},
    {
      icon: Users,
      title,
      description, unlocking Japan's stories through personal connections and insider access.",
      image,
      cta}
  ];
  ...
  const flagshipService = {
    ...
    expandedDescription, our master consultants craft journeys that transcend ordinary travel. Each itinerary is meticulously designed to reflect your personal vision of Japan, whether you seek the tranquility of temple gardens, the thrill of exclusive access, or the perfect balance of both.",
    image,
    features,
