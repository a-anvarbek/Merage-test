  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-nippon-obsidian">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/4 right-1/4 w-2 h-2 bg-nippon-gold opacity-50 animate-pulse" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-1/3 left-1/5 w-1 h-1 bg-nippon-rose-gold opacity-70 animate-pulse" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 right-1/6 w-1.5 h-1.5 bg-nippon-gold opacity-60 animate-pulse" style={{ animationDelay: '3s' }}></div>
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 text-center">
        ...
        <div className="mb-8" data-scroll-reveal>
          <div className="inline-flex items-center space-x-3 bg-nippon-gold/10 border border-nippon-gold/30 px-6 py-3 backdrop-blur-sm">
            <div className="w-2 h-2 bg-nippon-gold"></div>
            <span className="text-nippon-gold font-sans text-luxury-sm tracking-widest uppercase">By Invitation Only</span>
            <div className="w-2 h-2 bg-nippon-gold"></div>
          </div>
        </div>
        ...
        <div className="space-y-6 mb-12" data-scroll-reveal>
          ...
          <div className="text-nippon-rose-gold/70 font-serif text-luxury-2xl mb-4">日本帝国</div>
          ...
          <p className="text-nippon-platinum-white/80 font-sans text-luxury-lg max-w-3xl mx-auto leading-relaxed mt-8">
            For the discerning few who seek authentic cultural immersion beyond the ordinary—where every detail embodies the spirit of omotenashi and every moment becomes an extraordinary memory.
          </p>
        </div>
        ...
        <div className="space-y-8" data-scroll-reveal>
          ...
          <div className="flex justify-center">
            ...
            >
              <span className="relative flex items-center space-x-3 text-nippon-obsidian">
                ...
                <span className="tracking-wider font-medium text-nippon-obsidian">Request Private Consultation</span>
              </span>
            </Button>
          </div>
          ...
          <div className="flex items-center justify-center space-x-12 mt-12 text-nippon-platinum-white/60">
            <div className="text-center">
              <div className="text-nippon-gold font-serif text-luxury-xl">12</div>
              <div className="text-luxury-xs tracking-wider uppercase">Clients Annually</div>
            </div>
            <div className="w-px h-8 bg-nippon-gold/30"></div>
            <div className="text-center">
              <div className="text-nippon-gold font-serif text-luxury-xl">15+</div>
              <div className="text-luxury-xs tracking-wider uppercase">Years Excellence</div>
            </div>
            <div className="w-px h-8 bg-nippon-gold/30"></div>
            <div className="text-center">
              <div className="text-nippon-gold font-serif text-luxury-xl">100%</div>
              <div className="text-luxury-xs tracking-wider uppercase">Satisfaction</div>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Scroll indicator */}
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-nippon-platinum-white/60" data-scroll-reveal>
        <div className="flex flex-col items-center space-y-2">
          <span className="text-luxury-xs tracking-widest uppercase">Discover</span>
