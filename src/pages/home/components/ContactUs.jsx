        ...
        <div className="max-w-7xl mx-auto content-padding section-padding-sm">
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-12" data-scroll-reveal>
              <div className="warm-white-card-secondary p-8 shadow-elegant">
                <h2 className="text-luxury-3xl text-nippon-black font-serif mb-8 text-with-black-shadow">
                  How to Contact Us
                </h2>
                {/* Concierge, Email, Office, Follow Us sections same as before */}
              </div>
            </div>
              ...
              <div className="warm-white-card-secondary p-8 shadow-elegant">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <Input
                    ...
                    className="luxury-input h-12 text-luxury-base"
                    required
                  />
                  <Input
                    type="email"
                  ...
                  <Select value={formData.subject} onValueChange={(value) => handleInputChange('subject', value)}>
                    <SelectTrigger className="luxury-input h-12 text-luxury-base">
                  ...
                  <Textarea
                    ...
                    placeholder="Message"
                    rows={5}
                    className="luxury-input text-luxury-base resize-none"
                    required
                  />
                  <Checkbox
                    id="contactPhone"
