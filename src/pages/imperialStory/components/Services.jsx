...
import toriGateImage from '../assets/FujiSu.jpg';
import carInteriorImage from '../assets/Car.jpg';
import hotelBellImage from '../assets/Reseption.jpg';
...
export default function Services() {
  ...
  const missionPillars = [
    {
      ...
      description: "Every itinerary is crafted uniquely for you, reflecting your personal interests and desires for authentic Japanese experiences.",
      image: toriGateImage,
      alt: "Traditional torii gates pathway representing personalized spiritual and cultural journeys",
      features: ["Personalized cultural immersion", "Exclusive venue access", "Flexible scheduling"],
      kanji: "旅"
    },
    {
      title: "Seamless Transportation", 
      subtitle: "Effortless Movement",
      description: "Professional chauffeur services and luxury vehicles ensure every journey between destinations is comfortable and dignified.",
      image: carInteriorImage,
      alt: "Luxury vehicle interior with premium leather seating and modern amenities",
      features: ["Executive vehicle fleet", "Professional chauffeurs", "Punctual coordination"],
      kanji: "移"
    },
    {
      title: "Discreet Concierge",
      subtitle: "Omotenashi Excellence", 
      description: "Our dedicated team anticipates your needs with the timeless grace of Japanese hospitality, ensuring complete comfort.",
      image: hotelBellImage,
      alt: "Elegant hotel concierge bell representing attentive and discreet service",
      features: ["24/7 availability", "Cultural expertise", "Absolute discretion"],
      kanji: "心"
    }
  ];
  ...
  const seasonalExperiences = [
    {
      ...
      description: "Experience hanami season with exclusive access to private imperial gardens and centuries-old viewing traditions.",
      highlights: [
    ...
    },
    {
      ...
      description: "Immerse in Japan's vibrant summer festivals with VIP access to the most prestigious matsuri celebrations.",
      highlights: [
    ...
    },
    {
      ...
      description: "Witness the transformation of Japanese landscapes in a journey of contemplation and artistic inspiration.",
      highlights: [
    ...
    },
    {
      ...
      description: "Discover the profound beauty of Japan's winter landscapes through luxury ryokan experiences and cultural immersion.",
      highlights: [
  ...
  return (
    <section className="relative py-24 bg-nippon-white overflow-hidden">
      {/* Section Header */}
      <div className="max-w-7xl mx-auto px-6 text-center mb-20" data-scroll-reveal>
        <div data-stagger-container>
          ...
          <p className="text-luxury-lg text-nippon-charcoal max-w-4xl mx-auto leading-relaxed font-sans" data-stagger>
            At Nippon Imperial, we believe luxury is not just about lavishness—it is about feeling utterly cared for. Our mission is to curate bespoke journeys, seamless transportation and discreet concierge services that embody the spirit of omotenashi and introduce you to Japan's most extraordinary experiences.
          </p>
        </div>
      </div>
              ...
              <div className="luxury-card bg-nippon-white border border-nippon-beige/50 rounded-lg overflow-hidden shadow-luxury hover:shadow-floating transition-all duration-500">
                ...
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4 w-12 h-12 bg-nippon-gold/90 rounded-full flex items-center justify-center">
                    <span className="text-nippon-black font-serif text-lg">{pillar.kanji}</span>
                  </div>
                </div>
                ...
                <div className="p-8">
                  ...
                  <ul className="space-y-3 mb-8">
                    {pillar.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center text-nippon-charcoal text-luxury-sm font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6" data-scroll-reveal>
        <div className="text-center mb-16">
          ...
          <p className="text-nippon-charcoal text-luxury-base max-w-2xl mx-auto leading-relaxed">
            Each season reveals unique facets of Japanese culture, accessible only through our curated seasonal experiences that honor traditional timing and natural rhythms
          </p>
        </div>
            ...
            <div className="grid grid-cols-4 gap-2 p-2 bg-nippon-beige/50 rounded-lg border border-nippon-gold/20">
              {seasonalExperiences.map((experience, index) => (
                ...
                >
                  ...
                  <div className="text-sm uppercase tracking-wide">{experience.season}</div>
                </button>
              ))}
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                  ...
                  <div className="space-y-8">
                      ...
                      <ul className="space-y-3">
                        {experience.highlights.map((highlight, idx) => (
                          <li key={idx} className="flex items-start">
                            ...
                            <span className="text-nippon-charcoal">{highlight}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-nippon-gold/20">
                      <div>
                        ...
                        <div className="text-nippon-black">{experience.availability}</div>
                      </div>
                      <div>
                        <div className="text-nippon-gold-muted text-sm uppercase tracking-wide mb-2">
                          Exclusivity
                        </div>
                        <div className="text-nippon-black">{experience.exclusivity}</div>
                      </div>
                    </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute top-6 right-6 w-16 h-16 bg-nippon-gold/90 rounded-full flex items-center justify-center shadow-luxury">
                      <span className="text-nippon-black text-2xl font-serif">{experience.kanji}</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-nippon-beige/40 p-8 max-w-2xl mx-auto rounded-lg border border-nippon-gold/20">
            ...
            <p className="text-nippon-charcoal leading-relaxed">
              Our seasonal experiences honor traditional Japanese timing and natural cycles. 
              Each offering is carefully limited to preserve authenticity and ensure the most intimate cultural immersion.
            </p>
          </div>
        </div>
      </div>
